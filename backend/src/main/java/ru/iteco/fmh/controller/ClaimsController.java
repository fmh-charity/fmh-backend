...
public class ClaimsController {
    ...
    @GetMapping("/{id}")
    public ClaimDto getClaim(@Parameter(name = "Идентификатор заявки", required = true) @PathVariable int id) {
    ...
    public ClaimDto changeStatus(
            @Parameter(name = "Идентификатор заявки", required = true) @PathVariable("id") int claimId,
            @Parameter(name = "Новый статус для заявки", required = true) @RequestParam("status") Status status,
            @Parameter(name = "Исполнитель") @RequestParam(value = "executorId", required = false) Integer executorId,
            @Parameter(name = "Комментарий", required = true) @RequestBody ClaimCommentDto claimCommentDto) {
    ...
    public List<ClaimCommentDto> getAllClaimsComments(@Parameter(name = "Идентификатор заявки", required = true)
    ...
    public ClaimCommentDto createClaimComment(@Parameter(name = "Идентификатор заявки", required = true) @PathVariable("id") int id,
